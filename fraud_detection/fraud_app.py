...
st.set_page_config(
    page_title="DETECTION DE FRAUDES FINANCIERES", 
    layout="wide",
    page_icon="assets/img/tetebis.png",
...
st.logo("assets/img/tete.png", size='large')
...
ae_pipeline = joblib.load('models/ae_pipeline.pkl')
kmeans_pipeline = joblib.load('models/kmeans_pipeline.pkl')
lgbm_pipeline = joblib.load('models/lgbm_pipeline.pkl')
